...
public class ErrorParserTest
{
    ...
    public void testParseDuplicateQueryId()
    {
        ...
        final ClickHouseException exc = ClickHouseErrorParser.handle(ClickHouseErrorParser.parseError(content).orElseThrow());
        assertThat(exc).isInstanceOf(DuplicateQueryIdException.class);
        assertThat(exc.getErrorCode()).isEqualTo(216);
    }
}
